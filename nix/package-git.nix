{
  ...
  version ? "development",
  pname ? "simple-station-launcher-git",
}:
buildDotnetModule rec {
  ...
  postInstall = ''
    mkdir -p $out/lib/simple-station-launcher/loader
    cp -r SS14.Loader/bin/${buildType}/*/*/* $out/lib/simple-station-launcher/loader/

    icoFileToHiColorTheme SS14.Launcher/Assets/icon.ico simple-station-launcher $out
  '';
